...
const ViewFilmPlaceholder = (props: any) => {
    ...
    return (
        <div className="d-flex flex-column align-items-center align-items-sm-center p-4 placeholder-glow">
            ...
            <div className='d-flex flex-column col-12 flex-lg-row  align-items-center justify-content-lg-between justify-content-xxl-center'>
                <div className='d-flex flex-column col-12 col-sm-10 col-lg-4 col-xxl-4 mb-3 align-items-center me-xxl-5'>
                    <div className='d-flex flex-column align-self-center col-12 col-sm-10 col-lg-12 mb-3 mb-sm-0'>
                        <img className='img-fluid img-thumbnail placeholder' src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNgYAAAAAMAASsJTYQAAAAASUVORK5CYII=" alt="Film Hero" style={{ objectFit: 'cover' }} />
                    </div>
                </div>
            ...
            <div className='d-flex flex-column col-12 col-xxl-8 mb-4'>
